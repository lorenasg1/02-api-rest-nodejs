...
async function transactionsRoutes(app2) {
  app2.get("/", { preHandler: [checkSessionId] }, async (request) => {
    const sessionId = request.cookies.sessionId;
    const transactions = await knex("transactions").where("session_id", sessionId).select();
    return { transactions };
  });
  app2.get("/:id", { preHandler: [checkSessionId] }, async (request) => {
  ...
  app2.get("/summary", { preHandler: [checkSessionId] }, async (request) => {
    const sessionId = request.cookies.sessionId;
